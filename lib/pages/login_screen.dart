...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(  // ✅ Fix scrolling issue
        child: Center(
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                const SizedBox(height: 100),  // ✅ Reduced size
                Image.asset('assets/images/logo_f.png', height: 150), // ✅ Adjusted logo size
